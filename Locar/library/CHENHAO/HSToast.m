...
{
    [HSToast showToastWithText:text_ duration:DEFAULT_DISPLAY_DURATION];
}

+ (void)showToastWithText:(NSString *)text_ duration:(CGFloat)duration_
{
    HSToast *toast = [[HSToast alloc] initWithText:text_];
...
{
    [HSToast showToastWithText:text_  topOffset:topOffset_ duration:DEFAULT_DISPLAY_DURATION];
}

+ (void)showToastWithText:(NSString *)text_ topOffset:(CGFloat)topOffset_ duration:(CGFloat)duration_
{
    HSToast *toast = [[HSToast alloc] initWithText:text_];
    [toast setDuration:duration_];
...
{
    [HSToast showToastWithText:text_  bottomOffset:bottomOffset_ duration:DEFAULT_DISPLAY_DURATION];
}
